...
- 225 repository URLs were included in the corpus being tested
- 0 repository URLs in the corpus were skipped because they were duplicated
- 225 repository URLs being tested against the remaining rules
- 3.56 issues on average found in non-compliant certificate repository URLs
...
|-----------|------|--------|
| 225 | [e_atis_cache_header](ISSUES/e_atis_cache_header/README.md) | ATIS-1000074 |
| 176 | [e_http_status_200](ISSUES/e_http_status_200/README.md) | HTTP |
| 225 | [w_atis_content_type](ISSUES/w_atis_content_type/README.md) | ATIS-1000080 |
| 176 | [w_atis_pem_certificate_chain](ISSUES/w_atis_pem_certificate_chain/README.md) | ATIS-1000080 |
