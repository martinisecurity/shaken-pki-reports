...
- 311 repository URLs were included in the corpus being tested
- 0 repository URLs in the corpus were skipped because they were duplicated
- 311 repository URLs being tested against the remaining rules
- 3.22 issues on average found in non-compliant certificate repository URLs
...
|-----------|------|--------|
| 311 | [e_atis_cache_header](ISSUES/e_atis_cache_header/README.md) | ATIS-1000074 |
| 189 | [e_http_status_200](ISSUES/e_http_status_200/README.md) | HTTP |
| 311 | [w_atis_content_type](ISSUES/w_atis_content_type/README.md) | ATIS-1000080 |
