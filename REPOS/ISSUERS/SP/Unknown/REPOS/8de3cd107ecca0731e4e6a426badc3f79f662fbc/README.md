...
Name: `https://thevoiptalk.com/cert/sp-key.pem`\
...
| [e_http_status_200](../../ISSUES/e_http_status_200/README.md) | error | HTTP | HTTP response shall have StatusCode 200, but it is 403  |
