...
- 4508 certificates in the corpus were skipped because they are expired
...
- 5.45% of certificates are too old to be assessed against currently enforced expectations
- 114 days is the average remaining validity for the certificates in the corpus
- 111 days is the average initial validity for the certificates in the corpus
- 40 certificates expire in the next 30 days
- 1.12 average number of unexpired certificates per OCN observed
- 49 unique OCNs observed in unexpired and valid certificate corpus

| Instances | Test | Source |
|-----------|------|--------|
| 55 | [e_us_cp_subject_sn_shall](ISSUES/e_us_cp_subject_sn_shall/README.md) | US_SHAKEN_CP |
