...
- 5185 certificates in the corpus were skipped because they are expired
...
|-----------|------|--------|
| 32 | [e_us_cp_subject_sn_shall](ISSUES/e_us_cp_subject_sn_shall/README.md) | US_SHAKEN_CP |
