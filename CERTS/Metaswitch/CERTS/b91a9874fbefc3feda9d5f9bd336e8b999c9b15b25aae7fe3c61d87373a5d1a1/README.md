...
Remaining Validity Period: 3675 day(s)\
...
|------|------|--------|---------|
| [e_sti_ca_subject](../../ISSUES/e_sti_ca_subject/README.md) | error | ATIS&#x2011;1000080 | The DN shall contain a Country (C=) attribute, a Common Name (CN=) attribute and an Organization (O=) attribute |
