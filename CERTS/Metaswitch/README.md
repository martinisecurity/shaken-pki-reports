...
- 3.45% of certificates contain one or more Warning level issue
- 0.00% of certificates contain one or more Notice level issue
- 96.55% of certificates are too old to be assessed against currently enforced expectations
...
|-----------|------|--------|
| 29 | [e_atis_issuer_dn](ISSUES/e_atis_issuer_dn/README.md) | ATIS1000080 |
| 29 | [e_atis_key_usage](ISSUES/e_atis_key_usage/README.md) | ATIS1000080 |
