...
Remaining Validity Period: 3982 day(s)\
...
|------|------|--------|---------|
| [e_atis_ca_subject_public_key](../../ISSUES/e_atis_ca_subject_public_key/README.md) | error | ATIS&#x2011;1000080 | STI certificates shall contain a Subject Public Key Info field specifying a Public Key Algorithm of "id-ecPublicKey" and containing a 256-bit public key |
| [e_atis_ca_signature_algorithm](../../ISSUES/e_atis_ca_signature_algorithm/README.md) | error | ATIS&#x2011;1000080 | STI certificates shall contain a Signature Algorithm field with the value 'ecdsa-with-SHA256' |
