...
- 225 certificates were included in the corpus being tested
...
- 103 certificates being tested against the remaining rules
- 2.98 issues on average found in unexpired, trusted, and non-compliant certificates
- 96.12% of certificates contain one or more Error level issue
- 30.10% of certificates contain one or more Warning level issue
- 0.00% of certificates contain one or more Notice level issue
- 29.13% of certificates are too old to be assessed against currently enforced expectations
- 560 days is the average remaining validity for the certificates in the corpus
- 564 days is the average initial validity for the certificates in the corpus
- 2 certificates expire in the next 30 days
- 101 unique OCNs
- 1.02 average number of valid certificates per OCN

| Instances | Test | Source |
|-----------|------|--------|
| 85 | [e_atis_certificate_policies](ISSUES/e_atis_certificate_policies/README.md) | ATIS1000080 |
| 66 | [e_atis_extension_unknown](ISSUES/e_atis_extension_unknown/README.md) | ATIS1000080 |
