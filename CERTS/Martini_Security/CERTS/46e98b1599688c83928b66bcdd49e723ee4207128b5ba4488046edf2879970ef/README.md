...
|------|------|--------|---------|
| [n_atis_ca_certificate_policy_critical](../../ISSUES/n_atis_ca_certificate_policy_critical/README.md) | notice | ATIS&#x2011;1000080 | STI certificates should contain a CertificatePolicies extension marked uncritical |
