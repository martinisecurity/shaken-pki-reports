...
Tested At: 2022-10-28 19:21:57 +0000 UTC\
Initial Validity Period: 4380 day(s)\
Remaining Validity Period: 3678 day(s)\
...
|------|------|--------|---------|
| e_sti_ca_subject | error | ATIS-1000080 | The DN shall contain a Country (C=) attribute, a Common Name (CN=) attribute and an Organization (O=) attribute |
