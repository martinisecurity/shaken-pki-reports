...
- 352 certificates being tested against the remaining rules
- 96.02% of certificates contain one or more Error level issue
- 75.28% of certificates contain one or more Warning level issue
- 1.99% of certificates contain one or more Notice level issue
- 15.34% of certificates are too old to be assessed against currently enforced expectations
...
- 51.42% of certificate repositories contain one or more Error level issue
- 76.99% of certificates repositories contain one or more Warning level issue
...
|---------|--------------|--------|----------|---------|---------------|
| [Comcast](CERTS/Comcast/README.md#leaf-certificates) | 45 (12.78%) | 45 (100.00%) | 45 (100.00%) | 0 (0.00%) | 0 (0.00%) |
...
| [Metaswitch](CERTS/Metaswitch/README.md#leaf-certificates) | 21 (5.97%) | 21 (100.00%) | 6 (28.57%) | 0 (0.00%) | 20 (95.24%) |
| [NetNumber](CERTS/NetNumber/README.md#leaf-certificates) | 3 (0.85%) | 3 (100.00%) | 1 (33.33%) | 3 (100.00%) | 0 (0.00%) |
| [Neustar](CERTS/Neustar/README.md#leaf-certificates) | 95 (26.99%) | 89 (93.68%) | 33 (34.74%) | 0 (0.00%) | 32 (33.68%) |
...
| [Sansay](CERTS/Sansay/README.md#leaf-certificates) | 95 (26.99%) | 95 (100.00%) | 95 (100.00%) | 0 (0.00%) | 0 (0.00%) |
| [T-Mobile](CERTS/T-Mobile/README.md#leaf-certificates) | 1 (0.28%) | 1 (100.00%) | 1 (100.00%) | 0 (0.00%) | 0 (0.00%) |
| [TransNexus](CERTS/TransNexus/README.md#leaf-certificates) | 72 (20.45%) | 72 (100.00%) | 72 (100.00%) | 0 (0.00%) | 2 (2.78%) |
| **Total** | 352 (100.00%) | 338 (96.02%) | 265 (75.28%) | 7 (1.99%) | 54 (15.34%) |
