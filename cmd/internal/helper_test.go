...
func TestGetUniqueOCN(t *testing.T) {
	type args struct {
		c *x509.Certificate
	}
	tests := []struct {
		...
		},
		{
			name: "corrupted SPC",
			args: args{
				c: parseCertificate(t, ""),
			},
			want: "558J",
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := internal.GetUniqueOCN(tt.args.c); got != tt.want {
				t.Errorf("GetValidityDays() = %v, want %v", got, tt.want)
			}
		})
	}
